...
const INITIAL_PRODUCTS = [
  ...
  // 17. AERIAL MULTI SHOTS FANCY (105-110)
  ...
  // 18. SPECIAL FANCY FOUNTAIN (111-120)
  ...
  // 20. NEW ARRIVAL FOUNTAINS (131-137)
